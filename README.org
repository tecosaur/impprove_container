...
The input VCFs /must/ use the Hg38 reference genome, but this is not (currently)
validated.

To filter out common variants, use of [[https://github.com/brentp/slivar][slivar]] is recommended. This tool has
previously been tested with [[https://github.com/brentp/slivar/wiki/rare-disease][the recommended rare-disease slivar filter]]:
